...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, password, **extra_fields):
        """
        Create and save superuser account with given email and password.
        """
...
class CustomUser(AbstractUser):
    """
    Custom User Model, similar to Django defaut User Model, except the default "USERNAME_FIELD"
    is set to "email"
    """
